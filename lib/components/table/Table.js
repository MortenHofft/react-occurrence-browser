...
var Table = function (_Component) {
  ...
  Table.prototype.getHeaders = function getHeaders(classes) {
    ...
    return this.fieldConfig.fields.map(function (field, index) {
      ...
      var filterButton = field.filterWidget ? _react2.default.createElement(
        "i",
        {
  ...
  Table.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      this.state.showModalFilter && _react2.default.createElement(
        _ModalWidget2.default,
...
var hocWidget = function hocWidget(props) {
  return _react2.default.createElement(
    ...
    function (_ref) {
      ...
      return _react2.default.createElement(Table, _extends({}, props, { filter: filter, api: api, appSettings: appSettings }));
    }
  );
};
