...
var _MultiSuggest = require('./MultiSuggest');

var _MultiSuggest2 = _interopRequireDefault(_MultiSuggest);
...
var OmniSearch = function (_Component) {
  ...
  function OmniSearch(props) {
    ...
    _this.suggester = (0, _MultiSuggest2.default)();
  ...
  OmniSearch.prototype.render = function render() {
    ...
    var items = _lodash2.default.filter(this.state.fieldSuggestions, function (item) {
    ...
    if (_lodash2.default.isArray(this.state.suggestions) && this.state.suggestions.length > 0) {
      items.push({
        type: 'HEADER',
        col1: 'Value',
      ...
      items = _lodash2.default.concat(items, this.state.suggestions);
    }
    ...
    return _react2.default.createElement(
      ...
      this.state.showModal && _react2.default.createElement(ModalFilter, { onClose: this.handleHide, filter: this.props.filter, updateFilter: this.props.updateFilter, field: this.state.modalField })
    );
  };
...
exports.default = (0, _reactJss2.default)(_styles2.default)(OmniSearch);
