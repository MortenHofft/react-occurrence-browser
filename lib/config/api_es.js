...
function EsRequest(esEndpoint, filters) {
  var histogramBuckets = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(appQuery, keyField, buckets, minIntervalSize) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              interval = _lodash2.default.find(decimalRanges, function (x) {
                return x <= interval;
              });
  ...
  function compose(query) {
    ...
    _lodash2.default.forOwn(query.must, function (value, field) {
      var esField = _lodash2.default.get(filters[field], 'mapping', field);
      if (value.length == 1) {
        // only one value for field
        // decide if it should be added as a term, range or something else filter
        var val = value[0];
        if (!_lodash2.default.isUndefined(_lodash2.default.get(val, 'gte'))) {
        ...
        if (!_lodash2.default.isUndefined(_lodash2.default.get(value, '[0].gte'))) {
    ...
    _lodash2.default.forOwn(query.must_not, function (value, esField) {
      builder.filter('terms', esField, [].concat(value));
    });
  ...
  function count(appQuery) {
    ...
    return _axios2.default.post(esEndpoint + '/_count', body, {
      headers: {
  ...
  _lodash2.default.remove(decimalRanges, function (x) {
    return x === 2.5;
  });
