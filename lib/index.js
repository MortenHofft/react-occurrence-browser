...
var OccurrenceSearch = function (_Component) {
  ...
  function OccurrenceSearch(props) {
    ...
    var appSettings = (0, _configBuilder2.default)({ esEndpoint: _this.props.endpoint });
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_Layout2.default, {
          ...
          table: _react2.default.createElement(_Table2.default, { filter: this.state.filter, endpoint: this.props.endpoint, config: this.props.config, displayName: this.state.appSettings.displayName }),
          map: _react2.default.createElement(_Map2.default, { filter: this.state.filter, endpoint: this.props.endpoint, config: this.props.config, displayName: this.state.appSettings.displayName }),
          gallery: _react2.default.createElement(_Gallery2.default, { filter: this.state.filter, endpoint: this.props.endpoint, config: this.props.config, displayName: this.state.appSettings.displayName }),
