...
var Map = function (_Component) {
  ...
  Map.prototype.addLayer = function addLayer() {
    ...
    var tileString = "https://esmap.gbif-dev.org//api/tile/{x}/{y}/{z}.mvt?field=coordinate_point&url=" +
    ...
    encodeURIComponent("http:" + this.props.appSettings.esEndpoint + "/_search?") + "&filter=" + JSON.stringify(filter.query);
    this.map.addLayer({
      id: "occurrences",
      type: "circle",
      source: {
  ...
  Map.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement("div", { ref: this.myRef, className: classes.map })
    );
  };
...
var hocWidget = function hocWidget(props) {
  return React.createElement(
    ...
    function (_ref) {
      ...
      return React.createElement(Map, _extends({}, props, { appSettings: appSettings }));
    }
  );
};
