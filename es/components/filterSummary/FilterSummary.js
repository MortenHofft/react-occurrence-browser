...
var FilterSummary = function (_Component) {
    ...
    FilterSummary.prototype.render = function render() {
        ...
        Object.keys(must).forEach(function (param) {
            var displayName = _.get(appSettings.filters[param], 'displayName', appSettings.displayName(param).component); //TODO more consistency on how displayname is chosen
